...
Tested on openSLL 3.0.1


Example of creating a CA key and Cert then creating client, webserver, CRS and Certificate


Open and Debug examples/basic/basic.js using visual Code.
